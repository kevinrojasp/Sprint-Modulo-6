...
<h2 class="text-center display-6" style="margin-top: 20px;">Listado de pagos</h2>
    ...
    <div class="row">
        <div class="table-responsive">
            <table class="table" id="example">
                ...
                <tbody>
                <c:forEach var="pago" items="${listadoPagos}">
                    <tr>
                        <td>${pago.id}</td>
                        <td>${pago.rut}</td>
                        <td>${pago.monto}</td>
                        <td>
                            <form action="/editar-pago" method="get">
                        ...
                        <td>
                            <form action="/eliminar-pago" method="get">
